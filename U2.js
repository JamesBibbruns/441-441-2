...
// Check if there is a username in the cookie
...
// Register button click event on login page
...
// Navigation click event on index page
...
// Click login/signup link on index page
...
// Load different initialization functions depending on the page
function initPage() {
    ...
    if (path.includes("index.html")) {
        ...
        navigationClick(); // Ensure the navigationClick function is called on other pages as well
    }
}

// Initialize the page after it has finished loading
